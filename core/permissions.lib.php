...
function getPrimaryTagPermInArray($userId) {
  
}

function getSecondaryTagPermInArray($userId) {
  
}

function getGroupsWithTagPermission($tagId) {

}

function getUsersWithTagPermission($tagId) {
